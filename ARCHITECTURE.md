...
- **Customer-facing proactive / outbound messaging** (post-purchase check-ins, review requests, abandoned-cart nudges) — still deferred. The **owner-only** outbound email channel shipped 2026-06-10 (above) provides the send infrastructure, but messaging *customers* proactively raises consent/spam concerns and is out of scope; the shipped channel only ever emails the owner.
